...
from backend.option_pricing.utils.plot_utils import plot_binomial_price_histogram, plot_binomial_sensitivity
...
class TestBinomial(unittest.TestCase):
    def test_price(self):
        ...
        plot_binomial_price_histogram(put_option, N=n_steps, n_sim=500, save_path='backend/option_pricing/visualizations/test_binomial_put_hist.png')
        plot_binomial_sensitivity(put_option, 'spot', N=n_steps, save_path='backend/option_pricing/visualizations/test_binomial_put_sens_spot.png')
        ...
        # Plot histograma y sensibilidad
        plot_binomial_price_histogram(call_option, N=n_steps, n_sim=500, save_path='backend/option_pricing/visualizations/test_binomial_call_hist.png')
        plot_binomial_sensitivity(call_option, 'spot', N=n_steps, save_path='backend/option_pricing/visualizations/test_binomial_call_sens_spot.png')

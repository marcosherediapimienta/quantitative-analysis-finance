#!/usr/bin/env python
"""
Configuración de desarrollo para el backend Django.
Este archivo se puede usar para configuraciones específicas de desarrollo.
"""
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'quantitative-finance-dev-cache',
        'TIMEOUT': 300,
        'OPTIONS': {
            'MAX_ENTRIES': 1000,
        }

...
def binomial_greeks_european_option(S, K, T, r, sigma, N=1000, option_type='call', h=None):
    """
    ...
    # Vega
    vega_bump = 0.01
    price_vega_up = binomial_european_option_price(S, K, T, r, sigma + vega_bump, N, option_type)
    price_vega_down = binomial_european_option_price(S, K, T, r, sigma - vega_bump, N, option_type)
    vega = (price_vega_up - price_vega_down) / (2 * vega_bump)
    # Theta (backward difference)
    theta_bump = 0.01
    price_theta = binomial_european_option_price(S, K, T - theta_bump, r, sigma, N, option_type)
    theta = (price_theta - price) / theta_bump
    # Rho
    rho_bump = 0.01
    price_rho_up = binomial_european_option_price(S, K, T, r + rho_bump, sigma, N, option_type)
    price_rho_down = binomial_european_option_price(S, K, T, r - rho_bump, sigma, N, option_type)

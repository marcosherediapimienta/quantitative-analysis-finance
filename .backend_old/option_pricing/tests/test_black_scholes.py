...
from backend.option_pricing.utils.plot_utils import plot_bs_price_histogram, plot_bs_sensitivity
...
class TestBlackScholes(unittest.TestCase):
    def test_price(self):
        ...
        plot_bs_price_histogram(put_option, n_sim=500, save_path='backend/option_pricing/visualizations/test_bs_put_hist.png')
        plot_bs_sensitivity(put_option, 'spot', save_path='backend/option_pricing/visualizations/test_bs_put_sens_spot.png')
        ...
        # Plot histograma y sensibilidad
        plot_bs_price_histogram(call_option, n_sim=500, save_path='backend/option_pricing/visualizations/test_bs_call_hist.png')
        plot_bs_sensitivity(call_option, 'spot', save_path='backend/option_pricing/visualizations/test_bs_call_sens_spot.png')
